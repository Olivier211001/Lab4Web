...
paul = User.create!(nom: "Paul", prenom: "Tremblay", password: "123333", isadmin: true, email: "paul@tremblay.com")
george = User.create!(nom: "George", prenom: "Germain", password: "123333", isadmin: false, email: "george@germain.com")
jacque = User.create!(nom: "Jacque", prenom: "Germain", password: "123333", isadmin: false , email: "jacque@germain.com")
daniel = User.create!(nom: "Daniel", prenom: "Peterson", password: "123333", isadmin: false, email: "daniel@peterson.com")
robert = User.create!(nom: "Robert", prenom: "Skywalker", password: "123333", isadmin: true, email: "robert@skywalker.com")
